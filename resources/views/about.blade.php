                ...
                <div class="row">
                    <div class="col col-md-6">
                        <div class="left-col">
                            ...
                            <h3>Vision</h3>
                            <p>At Oasis Global, we envision a world where every person has access to quality education, healthcare, and social support. We are committed to creating sustainable solutions that empower individuals and transform communities, ultimately building a more just and equitable society for all.</p>
        ...
        <div class="row">
            <div class="col col-md-7 col-md-offset-5 details-text">
                <div class="wow fadeInRightSlow">
                    ...
                    <p>Partner with Oasis Global to support our mission of transforming lives through education, healthcare, advocacy, genda equality and women's empowerment. Join us today!</p>
